...
public class Main {
    ...
    public static void main(String[] args) {
        // Среднее количество продаж в месяц по каждому курсу за период - с первой до последней продажи
        ...
        // Количество продаж каждого курса с группировкой по месяцам
    ...
    private static void getAvgPurchases(Statement statement, String SQL_QUERY_AVG) throws SQLException {
        ...
        System.out.printf("%-35s | %14s | %21s | %21s | %17s |\n",
                "НАЗВАНИЕ КУРСА", "ПРОДАНО КУРСОВ", "ДАТА  НАЧАЛА  ПРОДАЖ",
                "ДАТА ОКОНЧАНИЯ ПРОДАЖ", "СРЕДНЕЕ ЗА ПЕРИОД");
